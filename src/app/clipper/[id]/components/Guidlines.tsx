...
const Guidlines = ({ guidelines }: { guidelines: string[] }) => {
  //Displaying guideline information for clippers
  return (
    <div className="ml-5 my-3 flex flex-col gap-5 md:flex-row xl:text-lg lg:mx-20 xl:my-10">
      <div>
      ...
      <div>
        <h2 className="text-secondary text-xl font-semibold sm:text-2xl xl:text-3xl">
          Custom Guidlines
        </h2>
